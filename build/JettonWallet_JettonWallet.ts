...
export function loadInternalTransfer(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 1536546933) { throw Error('Invalid prefix'); }
    const _from = sc_0.loadAddress();
    const _amount = sc_0.loadIntBig(257);
    return { $$type: 'InternalTransfer' as const, from: _from, amount: _amount };
}
...
export type SetMinter = {
    $$type: 'SetMinter';
    new_minter: Address;
}

export function storeSetMinter(src: SetMinter) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeUint(3800574984, 32);
        b_0.storeAddress(src.new_minter);
    };
}

export function loadSetMinter(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 3800574984) { throw Error('Invalid prefix'); }
    const _new_minter = sc_0.loadAddress();
    return { $$type: 'SetMinter' as const, new_minter: _new_minter };
}

export function loadTupleSetMinter(source: TupleReader) {
    const _new_minter = source.readAddress();
    return { $$type: 'SetMinter' as const, new_minter: _new_minter };
}

export function loadGetterTupleSetMinter(source: TupleReader) {
    const _new_minter = source.readAddress();
    return { $$type: 'SetMinter' as const, new_minter: _new_minter };
}

export function storeTupleSetMinter(source: SetMinter) {
    const builder = new TupleBuilder();
    builder.writeAddress(source.new_minter);
    return builder.build();
}

export function dictValueParserSetMinter(): DictionaryValue<SetMinter> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeSetMinter(src)).endCell());
        },
        parse: (src) => {
            return loadSetMinter(src.loadRef().beginParse());
        }
    }
}
...
async function JettonWallet_init(owner: Address, minter: Address) {
    const __code = Cell.fromHex('');
...
const JettonWallet_types: ABIType[] = [
    ...
    {"name":"InternalTransfer","header":1536546933,"fields":[{"name":"from","type":{"kind":"simple","type":"address","optional":false}},{"name":"amount","type":{"kind":"simple","type":"int","optional":false,"format":257}}]},
    {"name":"SetMinter","header":3800574984,"fields":[{"name":"new_minter","type":{"kind":"simple","type":"address","optional":false}}]},
    {"name":"JettonWallet$Data","header":null,"fields":[{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"minter","type":{"kind":"simple","type":"address","optional":false}},{"name":"balance","type":{"kind":"simple","type":"int","optional":false,"format":257}}]},
]

const JettonWallet_opcodes = {
    "InternalTransfer": 1536546933,
    "SetMinter": 3800574984,
}
...
const JettonWallet_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"typed","type":"SetMinter"}},
...
export class JettonWallet implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: SetMinter | InternalTransfer) {
        
        let body: Cell | null = null;
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'SetMinter') {
            body = beginCell().store(storeSetMinter(message)).endCell();
        }
