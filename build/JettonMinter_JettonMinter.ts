...
export function loadMint(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 275720840) { throw Error('Invalid prefix'); }
    const _to = sc_0.loadAddress();
...
export function loadSetOwner(slice: Slice) {
    const sc_0 = slice;
    if (sc_0.loadUint(32) !== 552748733) { throw Error('Invalid prefix'); }
    const _new_owner = sc_0.loadAddress();
    return { $$type: 'SetOwner' as const, new_owner: _new_owner };
}
...
export function loadJettonMinter$Data(slice: Slice) {
    ...
    return { $$type: 'JettonMinter$Data' as const, owner: _owner };
}
...
async function JettonMinter_init(owner: Address) {
    const __code = Cell.fromHex('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initJettonMinter_init_args({ $$type: 'JettonMinter_init_args', owner })(builder);
...
const JettonMinter_types: ABIType[] = [
    ...
    {"name":"Mint","header":275720840,"fields":[{"name":"to","type":{"kind":"simple","type":"address","optional":false}},{"name":"amount","type":{"kind":"simple","type":"int","optional":false,"format":257}}]},
    {"name":"SetOwner","header":552748733,"fields":[{"name":"new_owner","type":{"kind":"simple","type":"address","optional":false}}]},
    {"name":"JettonMinter$Data","header":null,"fields":[{"name":"owner","type":{"kind":"simple","type":"address","optional":false}}]},
]
...
export class JettonMinter implements Contract {
    ...
    static async init(owner: Address) {
        return await JettonMinter_init(owner);
    }
    
    static async fromInit(owner: Address) {
        const __gen_init = await JettonMinter_init(owner);
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: SetOwner | Mint) {
